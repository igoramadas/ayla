...
}(this, function (crel)
{
    ...
    function _format(data, prefixer, depth)
    {
        var result, key, keyNode, valNode,
            isEmpty = true,
            p = prefixer,
            type = getType(data);
        ...
        switch (type)
        {
            ...
            case ARRAY:
                ...
                {
                    result = crel("span",
                        {"class": p("type-array") + " " + p("empty")}, "(Empty List)");
                }
                break;
            default:
                result = crel("span", {"class": p("type-unk")}, "" + data);
                break;
        }

        $(result).addClass("depth-" + depth);
    ...
    function format(data, options)
    {
        ...
        result = _format(data, prefixer, 0);
